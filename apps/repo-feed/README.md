...
| `ARTICLE_EXPIRATION_SECONDS`  | Duration (in seconds) to keep articles.                  | `30 days`                                |
| `SCORE_EXPIRATION_SECONDS`    | Duration (in seconds) to keep scores.                    | `30 days`                                |
| `REDIS_SCORE_KEY`             | Redis score key                                          | `score`                                  |
| `REDIS_FEED_KEY`              | Redis feed key                                           | `feed`                                   |
| `REDIS_ARTICLE_KEY`           | Redis article key                                        | `article`                                |
| `REDIS_FEEDBACK_KEY`          | Redis feedback key                                       | `feedback`                               |
