...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/repo_article_src_api_dto.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/rss": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by begin date (YYYY-MM-DD)",
                        "name": "begin_at",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repo_article_src_api_dto.RSSResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/repo_article_src_api_dto.RSSCreateRequest"
                        }
                    },
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repo_article_src_api_dto.TreeRSSResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/rss/{name}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Rss update data",
                        "name": "rss",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/repo_article_src_api_dto.RSSUpdateRequest"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "repo_article_src_api_dto.ErrorResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "repo_article_src_api_dto.RSSResponse": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "repo_article_src_api_dto.RSSUpdateRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "repo_article_src_api_dto.TreeRSSResponse": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
